...
Imports System.Text
Public Class FrmReportBuilderClass
#Region "ODBC32 external function definitions"
    <DllImport("odbc32.dll")>
    Private Shared Function SQLAllocHandle(ByVal handleType As Short, ByVal inputHandle As IntPtr, ByRef outputHandlePtr As IntPtr) As Short
    End Function
    <DllImport("odbc32.dll")>
    Private Shared Function SQLSetEnvAttr(ByVal environmentHandle As IntPtr, ByVal attribute As Integer, ByVal valuePtr As IntPtr, ByVal stringLength As Integer) As Short
    End Function
    <DllImport("odbc32.dll")>
    Private Shared Function SQLFreeHandle(ByVal hType As Short, ByVal Handle As IntPtr) As Short
    End Function
    <DllImport("odbc32.dll", CharSet:=CharSet.Ansi)>
    Private Shared Function SQLBrowseConnect(ByVal handleConnection As IntPtr, ByVal inConnection As StringBuilder, ByVal stringLength As Short, ByVal outConnection As StringBuilder, ByVal bufferLength As Short, ByRef stringLength2Ptr As Short) As Short
    End Function
#End Region
#Region "Constants"
...
#End Region
    ...
    ''' <returns></returns>
    Private Function RetrieveInformation(ByVal InputParam As String) As String()
    ...
    ''' <returns></returns>
    Private Function ParseSQLOutConnection(ByVal outConnection As String) As String()
    ...
    End Function
    Private Sub FreeConnection(ByVal handleToFree As IntPtr)
