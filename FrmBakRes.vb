...
Public Class FrmBakRes
    ...
    Private Sub FrmBakRes_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        cmdOk.Text = Action
        Label7.Text = "DATABASE " + UCase(Action)
    ...
    Private Sub cmdOk_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdOk.Click
        ...
        If Action = "Backup" Then
            ...
            cmSQL.CommandText = "BACKUP DATABASE [" & txtAttachName.Text & "] TO DISK=N'" & Trim(txtDBName.Text) & "' WITH NOINIT, NOUNLOAD, NAME=N'ApexBusiness Backup', NOSKIP, STATS=10, NOFORMAT"
        ...
        Else
            ...
            cnSQL.Open()
            If Len(Dir("c:\ApexStipends" + Format(Now, "ddMMyy") + ".Bak")) > 0 Then
            ...
            End If
            cmSQL.CommandText = "BACKUP DATABASE [" & txtAttachName.Text & "] TO DISK=N'c:\ApexStipends" + Format(Now, "ddMMyy") + ".Bak' WITH NOINIT, NOUNLOAD, NAME=N'ApexStipends Backup', NOSKIP, STATS=10, NOFORMAT"
            cmSQL.CommandType = CommandType.Text
            cmSQL.ExecuteNonQuery()
