...
Public Class StipendSchedule1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApexStipends.StipendSchedule1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStipendSchedule1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StipendSchedule1 = New StipendSchedule1()
        rpt.Site = Me.Site
        Return rpt
    End Function
