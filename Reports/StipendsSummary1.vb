...
Public Class StipendsSummary1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApexStipends.StipendsSummary1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStipendsSummary1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StipendsSummary1 = New StipendsSummary1()
        rpt.Site = Me.Site
        Return rpt
    End Function
