...
Public Class SuspendedRegister
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApexStipends.SuspendedRegister.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSuspendedRegister
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SuspendedRegister = New SuspendedRegister()
        rpt.Site = Me.Site
        Return rpt
    End Function
