...
Public Class PayslipWithPict
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApexStipends.PayslipWithPict.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPayslipWithPict
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PayslipWithPict = New PayslipWithPict()
        rpt.Site = Me.Site
        Return rpt
    End Function
