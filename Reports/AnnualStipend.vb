...
Public Class AnnualStipend
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApexStipends.AnnualStipend.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAnnualStipend
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AnnualStipend = New AnnualStipend()
        rpt.Site = Me.Site
        Return rpt
    End Function
