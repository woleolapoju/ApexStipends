...
Public Class StipendsSummary
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ApexStipends.StipendsSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedStipendsSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As StipendsSummary = New StipendsSummary()
        rpt.Site = Me.Site
        Return rpt
    End Function
